...
/* ---------- Existing code for other sections and music ---------- */
// ... your existing code here (music, other modals, etc.)

/* ---------- Our Story Modals ---------- */

// Function to build the "Day We Met" modal HTML
function buildDayWeMetHTML(){
  const html = `
    <div class="modal-letter-wrap fade-in-stagger">
      <h2 class="modal-title">💫 6 September 2023 — The Day We Met 💫</h2>
      <div class="modal-deco">The day my life changed forever.</div>
      <div class="modal-letter">
...
// Function to build the "Birthday Story" modal HTML
function buildBirthdayStoryHTML(){
  const html = `
    <div class="modal-letter-wrap fade-in-stagger">
      <h2 class="modal-title">🎂 19 October — My Jaan’s Birthday 🎂</h2>
      <div class="modal-deco">The most special day of the year.</div>
      <div class="modal-letter">
        ...
        <p>Happy Birthday, my jaan, my Doha, my galaxy, my forever. 🌙<br>May every year of your life shine brighter than the one before — because you, my love, are the light that makes everything beautiful. 💫</p>
      </div>
    </div>
  `;
  return html;
...
/* ---------- Event listeners to trigger modals ---------- */
// Add your buttons or triggers here
document.querySelectorAll('.btn-day-we-met').forEach(btn => {
  btn.addEventListener('click', () => {
    showModal(buildDayWeMetHTML());
    playMusic(); // Assuming your music play function exists
  });
});

document.querySelectorAll('.btn-birthday-story').forEach(btn => {
  btn.addEventListener('click', () => {
    showModal(buildBirthdayStoryHTML());
    playMusic();
  });
});

// Assuming your existing modal functions: showModal, closeModal, fade-in effects, etc.
